...
public class contentCateServiceImpl implements contentCateService {
	...
	public TaotaoResult updateContentCat(long id, String name) {
		TbContentCategory tbContentCategory = tbContentCategoryMapper
	...
	@Override
	public TaotaoResult addContentCats(TbContent tbContent) {
	...
	@Override
	public TaotaoResult deleteContentCats(IdsForm ids) {
